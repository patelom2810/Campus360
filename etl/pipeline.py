...
Purpose: Master end-to-end ETL pipeline runner for the Data Engineering layer:
         Extract -> Transform & Clean -> Key Stitching -> PostgreSQL Load -> Data Quality Validation
"""
...
def run_pipeline():
    ...
    print("=" * 80)
    print("      KDAC-3 DATA ENGINEERING LAYER — MASTER ETL PIPELINE RUNNER       ")
    print("=" * 80)
    ...
    # 3. LOAD
    print("\n>>> STAGE 3: POSTGRESQL WAREHOUSE LOADING")
    load_counts = load_warehouse(warehouse_dfs)
